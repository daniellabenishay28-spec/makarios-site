...
interface HeaderProps {
  /**
   * "light" (défaut) = logo image blanche (logo-white.png) + nav blanche,
   * pour les pages à hero noir (la majorité des 26 maquettes V4). "dark" =
   * logo image noire (logo-dark.png) + nav noire, requis sur la page
   * Contact — seule page à ouvrir sur fond blanc, cf. Contact-Desktop.dc.html.
   * Même lockup logo officiel dans les deux cas, seule la couleur change.
   *
